...
![Regression Data](../img/amrnirr-regression-data.png)
...
![Regression Data With Line](../img/amrnirr-regression-data-w-line.png)
...
In the standard description, ridge regression is described as a constrained optmization problem:
...
![Regression Data With Ridge Lines](../img/amrnirr-regression-data-w-ridge-lines.png)
...
![Dispersed Regression Data](../img/amrnirr-dispersed-data.png)

To see the effect more clearly, let's color the upper and lower 10'th percentiles of the example regression data set:

![Regression Data with Shaded Tails](../img/amrnirr-dispersed-data-shaded-tails.png)

And then disperse the data with multiplicitie random noise:


![Dispersed Regression Data With Tails Highlighted](../img/amrnirr-regression-data-shaded-tails.png)
...
![Dispersed Regression Lines](../img/amrnirr-dispersed-regression-lines.png)
...
![Bundles of Dispersed Regression Lines](../img/amrnirr-dispersed-regression-lines-bundle.png)
...
![Bundles of Dispersed Regression Lines with Ridge Lines](../img/amrnirr-regression-comparisons.png)
...
In this equation, $G$ represents a matrix of random gaussian noise, the \(\ast\) operator is elementwise multiplication of matricies, and $E_G$ marginalizes out the contributions of the noise.
