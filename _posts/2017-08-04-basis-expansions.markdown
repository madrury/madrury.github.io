...
![Polynomail Regression Average Error by Degree]({{ site.url }}/img/polynomial-train-test-weird-signal.png){: .center-{{ site.url }}/img }
...
![PL Residuals for Varaious n-knots]({{ site.url }}/img/pl-residuals-various-degrees.png){: .center-{{ site.url }}/img }
